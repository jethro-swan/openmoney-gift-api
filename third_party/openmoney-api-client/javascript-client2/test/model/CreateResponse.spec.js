...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.CreateResponse();
  });
  ...
  describe('CreateResponse', function() {
    it('should create an instance of CreateResponse', function() {
      // uncomment below and update the code to test CreateResponse
      //var instane = new OpenmoneyApi.CreateResponse();
      //expect(instance).to.be.a(OpenmoneyApi.CreateResponse);
    });
