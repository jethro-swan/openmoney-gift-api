...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.StewardsResponse();
  });
  ...
  describe('StewardsResponse', function() {
    it('should create an instance of StewardsResponse', function() {
      // uncomment below and update the code to test StewardsResponse
      //var instane = new OpenmoneyApi.StewardsResponse();
      //expect(instance).to.be.a(OpenmoneyApi.StewardsResponse);
    });

    it('should have the property stewardname (base name: "stewardname")', function() {
      // uncomment below and update the code to test the property stewardname
      //var instane = new OpenmoneyApi.StewardsResponse();
