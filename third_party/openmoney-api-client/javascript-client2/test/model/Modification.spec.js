...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.Modification();
  });
  ...
  describe('Modification', function() {
    it('should create an instance of Modification', function() {
      // uncomment below and update the code to test Modification
      //var instane = new OpenmoneyApi.Modification();
      //expect(instance).to.be.a(OpenmoneyApi.Modification);
    });
