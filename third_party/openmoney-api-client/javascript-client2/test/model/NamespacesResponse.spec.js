...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.NamespacesResponse();
  });
  ...
  describe('NamespacesResponse', function() {
    it('should create an instance of NamespacesResponse', function() {
      // uncomment below and update the code to test NamespacesResponse
      //var instane = new OpenmoneyApi.NamespacesResponse();
      //expect(instance).to.be.a(OpenmoneyApi.NamespacesResponse);
    });
