...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.ApplicationRequest();
  });
  ...
  describe('ApplicationRequest', function() {
    it('should create an instance of ApplicationRequest', function() {
      ...
      //var instane = new OpenmoneyApi.ApplicationRequest();
      //expect(instance).to.be.a(OpenmoneyApi.ApplicationRequest);
    });
    ...
    it('should have the property homepageUri (base name: "homepage_uri")', function() {
    ...
    it('should have the property authorizationCallbackUri (base name: "authorization_callback_uri")', function() {
      // uncomment below and update the code to test the property authorizationCallbackUri
      //var instane = new OpenmoneyApi.ApplicationRequest();
      //expect(instance).to.be();
    });
