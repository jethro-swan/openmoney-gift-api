...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.ApplicationResponse();
  });
  ...
  describe('ApplicationResponse', function() {
    it('should create an instance of ApplicationResponse', function() {
      ...
      //var instane = new OpenmoneyApi.ApplicationResponse();
      //expect(instance).to.be.a(OpenmoneyApi.ApplicationResponse);
    });
    ...
    it('should have the property applicationSecret (base name: "application_secret")', function() {
      // uncomment below and update the code to test the property applicationSecret
      //var instane = new OpenmoneyApi.ApplicationResponse();
      //expect(instance).to.be();
    });
