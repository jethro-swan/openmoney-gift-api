...
------------- | ------------- | -------------
[**currenciesDelete**](CurrenciesApi.md#currenciesDelete) | **DELETE** /stewards/{stewardname}/namespaces/{namespace}/currencies/{currency} | Delete a currency
[**currenciesGet**](CurrenciesApi.md#currenciesGet) | **GET** /stewards/{stewardname}/namespaces/{namespace}/currencies/{currency} | Get a currency by its name
...
[**currenciesPost**](CurrenciesApi.md#currenciesPost) | **POST** /stewards/{stewardname}/namespaces/{namespace}/currencies | Create a currency
[**currenciesPut**](CurrenciesApi.md#currenciesPut) | **PUT** /stewards/{stewardname}/namespaces/{namespace}/currencies/{currency} | Update a Currency


<a name="currenciesDelete"></a>
# **currenciesDelete**
> DeleteResponse currenciesDelete(stewardname, namespace, currency, opts)
...
apiInstance.currenciesDelete(stewardname, namespace, currency, opts, callback);
```
...
# **currenciesGet**
> CurrenciesGet currenciesGet(stewardname, namespace, currency, opts)
...
apiInstance.currenciesGet(stewardname, namespace, currency, opts, callback);
```
...
# **currenciesPost**
> CreateResponse currenciesPost(stewardname, namespace, opts)
...
apiInstance.currenciesPost(stewardname, namespace, opts, callback);
```
...
# **currenciesPut**
> CreateResponse currenciesPut(stewardname, namespace, currency, opts)
...
apiInstance.currenciesPut(stewardname, namespace, currency, opts, callback);
```
