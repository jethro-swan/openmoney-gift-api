...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OpenmoneyApi.OauthAuthorizeRequest = factory(root.OpenmoneyApi.ApiClient);
  }
   ...
   * @class
   * @param responseType {String} One of code, password, refresh_token, client_credentials
   */
  var exports = function(responseType) {
    var _this = this;

    _this['response_type'] = responseType;
