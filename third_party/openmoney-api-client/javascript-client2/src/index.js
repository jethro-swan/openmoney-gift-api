...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccessTokenRequest', 'model/AccountsGet', 'model/AccountsList', 'model/AccountsRequest', 'model/AccountsResponse', 'model/AesEncryption', 'model/ApplicationRequest', 'model/ApplicationResponse', 'model/CreateResponse', 'model/CurrenciesGet', 'model/CurrenciesList', 'model/CurrenciesRequest', 'model/CurrenciesResponse', 'model/DeleteResponse', 'model/EncryptedJournals', 'model/ErrorModel', 'model/GetResponse', 'model/JournalsList', 'model/JournalsRequest', 'model/JournalsResponse', 'model/Modification', 'model/NamespacesGet', 'model/NamespacesList', 'model/NamespacesRequest', 'model/NamespacesResponse', 'model/OauthAuthorizeRequest', 'model/RegisterRequest', 'model/RegisterResponse', 'model/StewardsGet', 'model/StewardsList', 'model/StewardsRequest', 'model/StewardsResponse', 'model/TokenResponse', 'api/AccountsApi', 'api/AuthApi', 'api/CurrenciesApi', 'api/JournalsApi', 'api/NamespacesApi', 'api/StewardsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AccessTokenRequest'), require('./model/AccountsGet'), require('./model/AccountsList'), require('./model/AccountsRequest'), require('./model/AccountsResponse'), require('./model/AesEncryption'), require('./model/ApplicationRequest'), require('./model/ApplicationResponse'), require('./model/CreateResponse'), require('./model/CurrenciesGet'), require('./model/CurrenciesList'), require('./model/CurrenciesRequest'), require('./model/CurrenciesResponse'), require('./model/DeleteResponse'), require('./model/EncryptedJournals'), require('./model/ErrorModel'), require('./model/GetResponse'), require('./model/JournalsList'), require('./model/JournalsRequest'), require('./model/JournalsResponse'), require('./model/Modification'), require('./model/NamespacesGet'), require('./model/NamespacesList'), require('./model/NamespacesRequest'), require('./model/NamespacesResponse'), require('./model/OauthAuthorizeRequest'), require('./model/RegisterRequest'), require('./model/RegisterResponse'), require('./model/StewardsGet'), require('./model/StewardsList'), require('./model/StewardsRequest'), require('./model/StewardsResponse'), require('./model/TokenResponse'), require('./api/AccountsApi'), require('./api/AuthApi'), require('./api/CurrenciesApi'), require('./api/JournalsApi'), require('./api/NamespacesApi'), require('./api/StewardsApi'));
  }
}(function(ApiClient, AccessTokenRequest, AccountsGet, AccountsList, AccountsRequest, AccountsResponse, AesEncryption, ApplicationRequest, ApplicationResponse, CreateResponse, CurrenciesGet, CurrenciesList, CurrenciesRequest, CurrenciesResponse, DeleteResponse, EncryptedJournals, ErrorModel, GetResponse, JournalsList, JournalsRequest, JournalsResponse, Modification, NamespacesGet, NamespacesList, NamespacesRequest, NamespacesResponse, OauthAuthorizeRequest, RegisterRequest, RegisterResponse, StewardsGet, StewardsList, StewardsRequest, StewardsResponse, TokenResponse, AccountsApi, AuthApi, CurrenciesApi, JournalsApi, NamespacesApi, StewardsApi) {
  'use strict';
