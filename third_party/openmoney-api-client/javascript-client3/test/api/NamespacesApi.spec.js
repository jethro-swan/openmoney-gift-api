...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.NamespacesApi();
  });
  ...
  describe('NamespacesApi', function() {
    describe('spacesDelete', function() {
      it('should call spacesDelete successfully', function(done) {
        ...
        //instance.spacesDelete(pet, function(error) {
    ...
    describe('spacesGet', function() {
      it('should call spacesGet successfully', function(done) {
        ...
        //instance.spacesGet(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('spacesList', function() {
      it('should call spacesList successfully', function(done) {
        //uncomment below and update the code to test spacesList
        //instance.spacesList(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('spacesPost', function() {
      it('should call spacesPost successfully', function(done) {
        ...
        //instance.spacesPost(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('spacesPut', function() {
      it('should call spacesPut successfully', function(done) {
        ...
        //instance.spacesPut(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
