...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.CurrenciesRequest();
  });
  ...
  describe('CurrenciesRequest', function() {
    it('should create an instance of CurrenciesRequest', function() {
      // uncomment below and update the code to test CurrenciesRequest
      //var instane = new OpenmoneyApi.CurrenciesRequest();
      //expect(instance).to.be.a(OpenmoneyApi.CurrenciesRequest);
    });
