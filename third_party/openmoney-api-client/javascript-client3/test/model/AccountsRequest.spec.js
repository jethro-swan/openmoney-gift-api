...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.AccountsRequest();
  });
  ...
  describe('AccountsRequest', function() {
    it('should create an instance of AccountsRequest', function() {
      // uncomment below and update the code to test AccountsRequest
      //var instane = new OpenmoneyApi.AccountsRequest();
      //expect(instance).to.be.a(OpenmoneyApi.AccountsRequest);
    });
