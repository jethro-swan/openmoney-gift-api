...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.StewardsGet();
  });
  ...
  describe('StewardsGet', function() {
    it('should create an instance of StewardsGet', function() {
      // uncomment below and update the code to test StewardsGet
      //var instane = new OpenmoneyApi.StewardsGet();
      //expect(instance).to.be.a(OpenmoneyApi.StewardsGet);
    });
