...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.AccessTokenRequest();
  });
  ...
  describe('AccessTokenRequest', function() {
    it('should create an instance of AccessTokenRequest', function() {
      // uncomment below and update the code to test AccessTokenRequest
      //var instane = new OpenmoneyApi.AccessTokenRequest();
      //expect(instance).to.be.a(OpenmoneyApi.AccessTokenRequest);
    });
