...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.OauthAuthorizeRequest();
  });
  ...
  describe('OauthAuthorizeRequest', function() {
    it('should create an instance of OauthAuthorizeRequest', function() {
      ...
      //var instane = new OpenmoneyApi.OauthAuthorizeRequest();
      //expect(instance).to.be.a(OpenmoneyApi.OauthAuthorizeRequest);
    });
