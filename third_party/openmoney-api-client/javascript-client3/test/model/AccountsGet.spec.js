...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenmoneyApi.AccountsGet();
  });
  ...
  describe('AccountsGet', function() {
    it('should create an instance of AccountsGet', function() {
      // uncomment below and update the code to test AccountsGet
      //var instane = new OpenmoneyApi.AccountsGet();
      //expect(instance).to.be.a(OpenmoneyApi.AccountsGet);
    });
