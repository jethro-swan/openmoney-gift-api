...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OpenmoneyApi.StewardsResponse = factory(root.OpenmoneyApi.ApiClient, root.OpenmoneyApi.Modification);
  }
  ...
  /**
   * The StewardsResponse model module.
   * @module model/StewardsResponse
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>StewardsResponse</code>.
   * @alias module:model/StewardsResponse
   * @class
  ...
  /**
   * Constructs a <code>StewardsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StewardsResponse} obj Optional instance to populate.
   * @return {module:model/StewardsResponse} The populated <code>StewardsResponse</code> instance.
   */
