...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OpenmoneyApi.CurrenciesRequest = factory(root.OpenmoneyApi.ApiClient);
  }
  ...
  /**
   * The CurrenciesRequest model module.
   * @module model/CurrenciesRequest
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>CurrenciesRequest</code>.
   * @alias module:model/CurrenciesRequest
   * @class
  ...
  /**
   * Constructs a <code>CurrenciesRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CurrenciesRequest} obj Optional instance to populate.
   * @return {module:model/CurrenciesRequest} The populated <code>CurrenciesRequest</code> instance.
   */
