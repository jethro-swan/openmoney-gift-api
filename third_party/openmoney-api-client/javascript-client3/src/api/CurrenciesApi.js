...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.currenciesDelete = function(stewardname, currency, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'stewardname' is set
      if (stewardname == undefined || stewardname == null) {
        throw new Error("Missing the required parameter 'stewardname' when calling currenciesDelete");
      }

      // verify the required parameter 'currency' is set
      if (currency == undefined || currency == null) {
        throw new Error("Missing the required parameter 'currency' when calling currenciesDelete");
      }
     ...
     */
    this.currenciesGet = function(stewardname, currency, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'stewardname' is set
      if (stewardname == undefined || stewardname == null) {
        throw new Error("Missing the required parameter 'stewardname' when calling currenciesGet");
      }

      // verify the required parameter 'currency' is set
      if (currency == undefined || currency == null) {
        throw new Error("Missing the required parameter 'currency' when calling currenciesGet");
      }
    ...
    this.currenciesList = function(stewardname, opts, callback) {
      ...
      // verify the required parameter 'stewardname' is set
      if (stewardname == undefined || stewardname == null) {
        throw new Error("Missing the required parameter 'stewardname' when calling currenciesList");
      }
     ...
     */
    this.currenciesPost = function(stewardname, opts, callback) {
      opts = opts || {};
      var postBody = opts['currency'];

      // verify the required parameter 'stewardname' is set
      if (stewardname == undefined || stewardname == null) {
        throw new Error("Missing the required parameter 'stewardname' when calling currenciesPost");
      }
     ...
     * data is of type: {@link module:model/CreateResponse}
     */
    this.currenciesPut = function(stewardname, currency, opts, callback) {
      opts = opts || {};
      var postBody = opts['currencies'];

      // verify the required parameter 'stewardname' is set
      if (stewardname == undefined || stewardname == null) {
        throw new Error("Missing the required parameter 'stewardname' when calling currenciesPut");
      }

      // verify the required parameter 'currency' is set
      if (currency == undefined || currency == null) {
        throw new Error("Missing the required parameter 'currency' when calling currenciesPut");
      }
